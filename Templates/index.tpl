  ...
  <td background="img/nieuwvakmidden.gif" align=center>
   ...
   <table cellspacing=0 cellpadding=0 border=0 width=510>
    <tr>
     ...
     <td align=center width=170 id="goedlinksrechts"><I><font size=2 face=arial>{~CONSOLE2~}</font></I></td>
    ...
    <tr>
       ...
       <table cellspacing=0 cellpadding=0 border=0 width=127 height=97>
         <tr>
           <td width=120 height=90>
              <a href="gameview.php?id={~ID1~}"><img src="spellen/{~MAP1~}/display.jpg" border=0 width=120 height=90></A></td>
     ...
     <td align=center bgcolor=#FF0000 id="goedoveral">
       <table cellspacing=0 cellpadding=0 border=0 width=127 height=97>
         <tr>
           <td width=120 height=90>
              <a href="gameview.php?id={~ID2~}"><img src="spellen/{~MAP2~}/display.jpg" border=0 width=120 height=90></A></td>
           <td width=7 height=90><img src="img/schaduwrechts.gif" border=0></td>
         </tr>
         <tr>
           <td colspan=2 width=127 height=7><img src="img/schaduwonder.gif" border=0></td>
     ...
     <td align=center bgcolor=#FF0000 id="goednietlinks">
       <table cellspacing=0 cellpadding=0 border=0 width=127 height=97>
         <tr>
           <td width=120 height=90>
              <a href="gameview.php?id={~ID3~}"><img src="spellen/{~MAP3~}/display.jpg" border=0 width=120 height=90></A></td>
           <td width=7 height=90><img src="img/schaduwrechts.gif" border=0></td>
         </tr>
         <tr>
           <td colspan=2 width=127 height=7><img src="img/schaduwonder.gif" border=0></td>
    ...
    <tr>
     <td align=center width=170><a href="gameview.php?id={~ID1~}"><b><font size=2 face=arial>{~NAAM1~}</font></b></a></td>
     <td align=center width=170 id="goedlinksrechts"><a href="gameview.php?id={~ID2~}"><b><font size=2 face=arial>{~NAAM2~}</font></b></a></td>
     <td align=center width=170><a href="gameview.php?id={~ID3~}"><b><font size=2 face=arial>{~NAAM3~}</font></b></a></td>
    </tr>
   </table>
...
<table  cellspacing=0 cellpadding=0 border=0 width=526>
  ...
  <tr>
    <td><a href="shownieuws.php?id={~NIEUWSID~}"><font size=2 face=arial><I>Zie reacties ({~REACTIES~})</I></font></a></td>
  </tr>
</table><p>
{~NIEUWS~}
[END BLOCK nieuws]