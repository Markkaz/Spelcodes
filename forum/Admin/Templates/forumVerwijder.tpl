<TABLE cellspacing=0 cellpadding=0 border=0 width=550>
 ...
 <tr>
  <td background="../../img/nieuwvaklinks.gif">&nbsp;</td><form action="forumVerwijder.php?forumid={~FORUMID~}" method="post">
  <td background="../../img/nieuwvakmidden.gif" align=center>
  Weet je zeker dat je het forum met forumID <b>{~FORUMID~}</b> wil verwijderen?<p>
  
  <b>Waarschuwing: Dit kan alleen als je eerst alle topics in dit forum verwijderd!</b><p>
  
  <input type="hidden" name="delete" value=1>
  <input type="submit" value="JA">
  <input type="button" value="NEE" onClick="location.replace('index.php')">
  </td></form>
