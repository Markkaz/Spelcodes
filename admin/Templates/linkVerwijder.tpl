<TABLE cellspacing=0 cellpadding=0 border=0 width=550>
 ...
 <tr>
  <td background="../img/nieuwvaklinks.gif">&nbsp;</td><form action="linkVerwijder.php?id={~ID~}" method="post">
  <td background="../img/nieuwvakmidden.gif" align=center>
  Weet je zeker dat je recordID <b>{~ID~}</b> wil verwijderen?<br>
  
  <input type="hidden" name="delete" value="1">
  
  <input type="submit" value="JA">
  <input type="button" value="NEE" onClick="location.replace('links.php')">
  </td></form>
