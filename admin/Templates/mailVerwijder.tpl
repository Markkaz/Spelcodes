<TABLE cellspacing=0 cellpadding=0 border=0 width=550>
 ...
 <tr>
  <td background="../img/nieuwvaklinks.gif">&nbsp;</td><form action="mailVerwijder.php?mailid={~MAILID~}" method="post">
  <td background="../img/nieuwvakmidden.gif" align=center>
  Weet je zeker dat je de email met mailID <b>{~MAILID~}</b> wil verwijderen?<p>
  
  <input type="hidden" name="delete" value=1>
  <input type="submit" value="JA">
  <input type="button" value="NEE" onClick="location.replace('mail.php')">
  </td></form>
