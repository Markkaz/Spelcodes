<TABLE cellspacing=0 cellpadding=0 border=0 width=550>
 ...
 <tr>
  <td background="../img/nieuwvaklinks.gif">&nbsp;</td><form action="addGameVerwijder.php?id={~ID~}&spelid={~SPELID~}" method="post">
  <td background="../img/nieuwvakmidden.gif" align=center>
  Weet je zeker dat je spelID <b>{~SPELID~}</b> wil verwijderen van de console pagina en de homepage?<p>
  
  <input type="hidden" name="delete" value="1">
  
  <input type="submit" value="JA">
  <input type="button" value="NEE" onClick="location.replace('addGame.php?id={~ID~}')">
  </td>
  </form>
