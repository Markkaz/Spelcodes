<TABLE cellspacing=0 cellpadding=0 border=0 width=550>
 ...
 <tr>
  ...
  <form action="topicsSpellenVerwijder.php?topicid={~TOPICID~}&spelid={~SPELID~}" method="post">
  <td background="../img/nieuwvakmidden.gif" align=center>
  Weet je zeker dat je recordID <b>{~TOPICID~}</b> wil verwijderen?<p>
  
 <B>   Waarschuwing: Alle reacties op dit topic zullen ook verwijderd worden!<p>
  </B>
