<TABLE cellspacing=0 cellpadding=0 border=0 width=550>
 ...
 <tr>
  <td background="../img/nieuwvaklinks.gif">&nbsp;</td><form action="nieuwsVerwijder.php?id={~ID~}" method="post">
  <td background="../img/nieuwvakmidden.gif" align=center>
Weet je zeker dat je record-ID <b>{~ID~}</b> wil verwijderen?<p>
<b>Waarschuwing: Als je een nieuwsbericht verwijderd, zullen ook alle reacties verwijderd worden!</b><p>

  <input type="hidden" name="delete" value="1">
  
  <input type="submit" value="JA">
  <input type="button" value="NEE" onClick="location.replace('nieuws.php')">
  </td></form>
