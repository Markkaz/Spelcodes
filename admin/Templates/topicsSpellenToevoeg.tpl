...
<TABLE cellspacing=0 cellpadding=0 border=0 width=550>
 ...
 <tr>
  ...
  <form action="topicsSpellenToevoeg.php?spelid={~SPELID~}" method="post">
  <td background="../img/nieuwvakmidden.gif" align=center>
  <table border=0>
    <tr>
      <td width=70>Titel topic: </td>
      <td width=*><input type="text" name="titel"></td>
    </tr>
    <tr>
      <td colspan=2>Bericht:<br>
      <textarea rows=12 cols=60 name="bericht"></textarea></td>
    </tr>
    <tr>
